...
public class CustomerOrders extends javax.swing.JFrame {
    ...
    public CustomerOrders(Customer loggedInCustomer) {
        ...
        for(Map.Entry<Integer, Order> oEntry : currentCustomer.getOrders().entrySet()){
            Order actualOrder = oEntry.getValue();
            
            if(actualOrder.getStatus().equals("Complete")){
                orders.addRow(new Object[]{actualOrder.getOrderId(), 
    ...
    private void view_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_view_btnActionPerformed
        if(orders_tbl.getSelectedRow() == -1){
            ...
            int orderId = Integer.parseInt(String.valueOf(orders_tbl.getValueAt(rowSelected, 0)));
            
            ViewPreviousOrdersLines custOrdersLines = new ViewPreviousOrdersLines(currentCustomer, currentCustomer, orderId);
            this.dispose();
